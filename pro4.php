...
.me {
  ...
  border-radius: 80px;
  margin: 0 auto;
  background:  url(mansa.jpg) center; 
  background-size: cover;
...
<div id="body-wrapper">
  ...
  <div class="name">Manasa Bharadwaj<h3>Lucknow, India</h3></div>
  ...
  <div class="row">    
      <div class="content">
        ...
        <div class="info">
          <p>
			We at "Ambiance" undertake interiors & turnkey projects. We also provide services like Design consultation, Painting consultation, Floor plans for residential & commercial projects, Interior photography.  </p>
        </div>
      </div> 
  </div>
  ...
  <div class="row">
    <div class="dot l">
      <h2>Service Provided</h2>
		Conceptual designing, Color consultation, Interiors for residential & commercial projects, Executation


    </div>
    <div class="dot r">
      <b><big>Contact:</b></big>09482840704 <br><br> <b><big>Location:</b></big>Rajarajeshwari Nagar Lucknow,India
    </div>
    <div class="dot l">
    ...
    <div class="dot r">
      <b><big>Projects:</b></big>11&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=''>View Projects</a><br></br><br><br>
