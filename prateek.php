...
.me {
  ...
  border-radius: 80px;
  margin: 0 auto;
  background:  url(prateek.jpg) center; 
  background-size: cover;
...
<div id="body-wrapper">
  ...
  <div class="name">Prateek Khandare<h3>Pune, India</h3></div>
  ...
  <div class="row">    
      <div class="content">
        ...
        <div class="info">
          <p>
			I would like to take this opportunity to briefly introduce our company Destined Design that has been in profile of Interior design for the past 5 years. 
We have been an established and popular company with an excellent track record for the best customer satisfaction. We have never compromised on the quality and the services provided to the customer. We believe in keeping the customers happy and providing them best service. We have an excellent staffs who will guide you with their best ideas by keeping in constant touch with your company and informing about the market trends. 
  ...
  <div class="row">
    <div class="dot l">
      <h2>Service Provided</h2>Inerior Designing consultancy and execution
		<br>Areas Served : All
    </div>
    <div class="dot r">
      <b><big>Contact:</b></big>+91 9028669984<br><br> <b><big>Location:</b></big>Pune, India,411038
    </div>
    <div class="dot l">
     <b><big>Please fell free to keep in touch with us about any work related / requirement queries .We look forward to a wonderful relationship together and success for all concerned. </b></big>
    </div>
    <div class="dot r">
      <b><big>Projects:</b></big>4&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=''>View Projects</a><br></br><br><br>
