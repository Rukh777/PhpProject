...
.me {
  ...
  border-radius: 80px;
  margin: 0 auto;
  background:  url(anjali.jpg) center; 
  background-size: cover;
...
<div id="body-wrapper">
  ...
  <div class="name">Anjali Rawat<h3>Delhi, India</h3></div>
  ...
  <div class="row">    
      <div class="content">
        ...
        <div class="info">
          <p>
			Anjali rawat is a young  design consultancy firm with a vast experience in the field on interior designinng.
			with projects spread across india with strong presence in Delhi. 
			</p>
        </div>
      </div> 
  </div>
  ...
  <div class="row">
    ...
    <div class="dot r">
      <b><big>Contact:</b></big>+91 86555 90900<br><br> <b><big>Location:</b></big>102, Falcon court ,Hari Om nagar, Delhi , India
    </div>
    <div class="dot l"><br>
     <b><big> Areas:&nbsp;&nbsp;&nbsp; <br>
				India
    ...
    <div class="dot r">
      <b><big>Projects:</b></big>16&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=''>View Projects</a><br></br><br><br>
