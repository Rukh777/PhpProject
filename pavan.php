...
.me {
  ...
  border-radius: 80px;
  margin: 0 auto;
  background:  url(pavan.jpg) center; 
  background-size: cover;
...
<div id="body-wrapper">
  ...
  <div class="name">Pawan K<h3>Hyderabad, India</h3></div>
  ...
  <div class="row">    
      <div class="content">
        ...
        <div class="info">
          <p>
	A vast experience in the field on interior designinng
  ...
  <div class="row">
    <div class="dot l">
      <big><b>Service Provided:<b></big><br><br>Residental,commercial,corporate interiors and architectural designs
		
		

    </div>
    <div class="dot r">
      <b><big>Contact:</b></big>+91 924620-7542<br><br> <b><big>Location:</b></big>rdno.18,jubilee hills Hyderabad,India
    </div>
    <div class="dot l"><br>
     <b><big> Areas:&nbsp;&nbsp;&nbsp; <br>
				Hyderabad<br>Pune <br> Mumbai
	 </b></big>
    </div>
    <div class="dot r">
      <b><big>Projects:</b></big>10&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=''>View Projects</a><br></br><br><br>
