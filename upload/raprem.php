...
.me {
  ...
  border-radius: 80px;
  margin: 0 auto;
  background:  url(Raprem.jpg) center; 
  background-size: cover;
...
<div id="body-wrapper">
  ...
  <div class="name">Ra Prem<h3>Chennai, India</h3></div>
  ...
  <div class="row">    
      <div class="content">
        ...
        <div class="info">
          <p>
			Bull was borne from a single principle, ‘never say no’, and we continue to grow based on this one philosophy. 
Interior designing is said to be the extension of a persons personality so we design each and every square foot of your space carefully 
Not just stocking furniture's and loading paint is interior designing there is much more than that. 
We offer professional advice, to suit customers needs and preferences. 
The main focus of our company is to provide quality products and reliable service in a constantly changing market. 
In a volatile economic environment our experience and knowledge of the trade enables us to provide you with many more options to our clients. 
Our workmanship and access to the latest machinery results in a high end finish to suit our clients needs. 
With the latest products in the market available to us, there is no job criteria we cannot meet. 
We priorities to give customer satisfaction.Our final product always exceeds your expectations. 
All members of our team are fully qualified. 
We will help manage your project on time.
  ...
  <div class="row">
    <div class="dot l">
      <big><b>Service Provided:<b></big><br><br>Inerior Designing consultancy and execution
		Architectural Design Service 
		3D rendering and Schematics 
		Interior Design Service 
		Purchasing Service 

    </div>
    <div class="dot r">
      <b><big>Contact:</b></big>+91 9884828636<br><br> <b><big>Location:</b></big>New No 71 Old No11 Jawaharlal Nehru Street,Chennai, India,600026
    </div>
    <div class="dot l"><br>
     <b><big> Areas:&nbsp;&nbsp;&nbsp;Rane Madras <br>
				Mailhem Ikos <br>
				Sundari Silks <br>
				Benz
	 </b></big>
    ...
    <div class="dot r">
      <b><big>Projects:</b></big>8&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=''>View Projects</a><br></br><br><br>
