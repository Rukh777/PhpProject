	...
	<table align='center' width='100%' cellspacing='0' cellpadding='5'>
		<tr align='center' width='100%'>
			<td colspan='3' bgcolor='ccfb5d' align='left' width='10' style='text-align:center;font-size:50px;font-weight:bold;font-style:Parchment'>
							<font face ='Parchment' size='+10' color=''><big>Dinning Room Styles</big></font>
			</td>
		</tr>
		...
		<?php
								...
								//$sql="select * from dinningstyle";
								//$ds=mysql_query($sql);
								$r=mysqli_query($con, "select * from dinningstyle");
