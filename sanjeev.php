...
.me {
  ...
  border-radius: 80px;
  margin: 0 auto;
  background:  url(sanjeev.jpg) center; 
  background-size: cover;
...
<div id="body-wrapper">
  ...
  <div class="name">Sanjeev Khanna<h3>Jalandhar, India</h3></div>
  ...
  <div class="row">    
      <div class="content">
        ...
        <div class="info">
          <p>
					Want your room to have a complete new look without breaking any walls or civil work? A home can look absolutely new and fresh by changing the curtains, adding a couple of cushions, adding a magnificently patterned rug or adding an exquisite piece of furniture. I love making people's house into their personal space- into their home. I stylize interiors by working around the soft furnishing and other home decor products to make every space I work with unique and personalized. 
			</p>
        </div>
      </div> 
  </div>
  ...
  <div class="row">
    <div class="dot l">
      <big><b>Service Provided:<b></big><br><br>Interior stylist, Textile designer and Soft furnishing consultant		

    </div>
    <div class="dot r">
      <b><big>Contact:</b></big>+91 924620-7542<br><br> <b><big>Location:</b></big>13/11, Central Town, Jalandhar , Dc 14001,India
    </div>
    <div class="dot l"><br>
