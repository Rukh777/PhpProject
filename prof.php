...
.sheath {
  width: 100%;
  position: absolute;
  background: -webkit-gradient(linear, left top, right top, color-stop(0%, rgba(53,53,53, .2)), color-stop(100%, rgba(53,53,53, .3)));
}
.content {
  opacity: 0;
  padding: 1px;
  width: 100%;
  margin: 0 auto;
  background: -webkit-gradient(linear, left top, right top, color-stop(0%, rgba(89,120,145, .5)), color-stop(100%, rgba(141,149,167, .6)));
...
.name {
  ...
  padding: 50px;
  margin: 0 auto 5%;
  background: -webkit-gradient(linear, left top, right top, color-stop(0%, rgba(53,53,53, .2)), color-stop(100%, rgba(53,53,53,.8)));
...
//$sql="select * from pros where name='$name'";
								//$ds=mysql_query($sql);
								$r=mysqli_query($con, "select * from pros where name='$name'");
		...
		echo"<div class='sheath'>
<div id='body-wrapper'>
  
  <div class='name'>$name<h3>$address</h3></div>
  
  <div class='row'>    
      <div class='content'>
        <div class='me' style='background:url($pic)center;background-repeat:no-repeat;opacity: 0;
  height: 160px;
  width: 160px;
  border-radius: 80px;
  margin: 0 auto;
  ...
  <div class='row'>
   ...
   <b> $service<b>
    ...
    <div class='dot r'>
      <b><big>$contact</big>    </div>
    <div class='dot l'>
     <b> $awards<b>
    </div>
    <div class='dot r'>
      <b><big>Projects:</b></big>13&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
