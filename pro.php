...
.me {
  ...
  border-radius: 80px;
  margin: 0 auto;
  background:  url(sonali.jpg) center; 
  background-size: cover;
...
<div id="body-wrapper">
  ...
  <div class="name">Sonali Shah<h3>Mumbai, India</h3></div>
  ...
  <div class="row">    
      <div class="content">
        ...
        <div class="info">
          <p>
			Interior Designers & Decorators<br>Practising modern high end residentials interiors in mumbai,india
		   </p>
        </div>
      </div> 
  </div>
  ...
  <div class="row">
    ...
    <div class="dot r">
      <b><big>Contact:</b></big>919820333059<br><br> <b><big>Location:</b></big>154 S.V. road, vile parle west,next to golden tobacco, behind bharat furnishngs,Mumbai 400056
    </div>
    <div class="dot l">
     <b><big> Certification And Awards:</b></big> <br><br> llld awrds, iad awrds,aces pf space awards.
    </div>
    <div class="dot r">
      <b><big>Projects:</b></big>13&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='1.php'>View Projects</a><br></br><br><br>
