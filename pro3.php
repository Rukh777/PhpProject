...
.me {
  ...
  border-radius: 80px;
  margin: 0 auto;
  background:  url(neelu.jpg) center; 
  background-size: cover;
...
<div id="body-wrapper">
  ...
  <div class="name">Neelu Singh<h3>Banglore, India</h3></div>
  ...
  <div class="row">    
      <div class="content">
        ...
        <div class="info">
          <p>
			I am an interior designer based out of Whitefield, Bangalore. I specialize in functional, elegant and luxurious residential designs: entertainment units, cabinets, bar counters, partitions, pooja rooms, wardrobes, false ceilings, kitchens, furniture, wall cladding, texture painting, custom-designed wall art, murals etc., just to name a few. 		   </p>
        </div>
      </div> 
  </div>
...
Interior Design and implementation, consultation on material selection, wall art, soft furnishings, lights, bathrooms etc.

			Areas Served : All
    </div>
    <div class="dot r">
      <b><big>Contact:</b></big>+91 9945001156<br><br> <b><big>Location:</b></big>20E, Asset Enclave, Whitefield
Bengaluru
Bangalore
Karnataka
560 066
    ...
    <div class="dot l">
     <b><big> Certification And Awards:</b></big> <br><br> llld awrds, iad awrds,aces pf space awards.
    </div>
    <div class="dot r">
      <b><big>Projects:</b></big>14&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=''>View Projects</a><br></br><br><br>
